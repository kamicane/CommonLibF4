...
namespace RE::Scaleform::GFx
{
	...
	public:
		...
		public:
			...
			public:
				...
				// add
				virtual void Visit(std::uint32_t a_index, const Value& a_val) = 0; // 00
			};
			...
			{
				static REL::Relocation<decltype(&ObjectInterface::ObjectAddRef)> func{ ::Scaleform::ID::GFx::Value::ObjectAddRef };
				return func(this, a_val, a_obj);
			}

			void ObjectRelease(Value* a_val, void* a_obj)
			{
				static REL::Relocation<decltype(&ObjectInterface::ObjectRelease)> func{ ::Scaleform::ID::GFx::Value::ObjectRelease };
				return func(this, a_val, a_obj);
			}

			bool HasMember(void* a_data, const char* a_name, bool a_isdobj) const
			{
				static REL::Relocation<decltype(&ObjectInterface::HasMember)> func{ ::Scaleform::ID::GFx::Value::HasMember };
				return func(this, a_data, a_name, a_isdobj);
			}

			std::uint32_t GetArraySize(void* a_data) const
			{
				static REL::Relocation<decltype(&ObjectInterface::GetArraySize)> func{ ::Scaleform::ID::GFx::Value::GetArraySize };
				return func(this, a_data);
			}

			bool GetMember(void* a_data, const char* a_name, Value* a_val, bool a_isdobj) const
			{
				static REL::Relocation<decltype(&ObjectInterface::GetMember)> func{ ::Scaleform::ID::GFx::Value::GetMember };
			...
			{
				static REL::Relocation<decltype(&ObjectInterface::SetMember)> func{ ::Scaleform::ID::GFx::Value::SetMember };
			...
			{
				static REL::Relocation<decltype(&ObjectInterface::Invoke)> func{ ::Scaleform::ID::GFx::Value::Invoke };
				return func(this, a_data, a_result, a_name, a_args, a_numArgs, a_isdobj);
			}

			bool PushBack(void* a_data, const Value& a_value)
			{
				static REL::Relocation<decltype(&ObjectInterface::PushBack)> func{ ::Scaleform::ID::GFx::Value::PushBack };
				return func(this, a_data, a_value);
			}

			bool RemoveElements(void* a_data, std::uint32_t a_index, std::int32_t a_count)
			{
				static REL::Relocation<decltype(&ObjectInterface::RemoveElements)> func{ ::Scaleform::ID::GFx::Value::RemoveElements };
				return func(this, a_data, a_index, a_count);
			}

			void VisitMembers(void* a_data, ObjVisitor* a_visitor, bool a_isDObj) const
			{
				static REL::Relocation<decltype(&ObjectInterface::VisitMembers)> func{ ::Scaleform::ID::GFx::Value::VisitMembers };
				return func(this, a_data, a_visitor, a_isDObj);
			}

			bool GetDisplayInfo(void* a_data, DisplayInfo* a_info) const
			{
				static REL::Relocation<decltype(&ObjectInterface::GetDisplayInfo)> func{ ::Scaleform::ID::GFx::Value::GetDisplayInfo };
	...
	private:
		...
		{
			const auto managed = _type.any(ValueType::kManagedBit);
		...
		SFFlags<ValueType, std::int32_t> _type{ ValueType::kUndefined }; // 08
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::Scaleform__GFx__FunctionHandler };
		inline static constexpr auto VTABLE{ VTABLE::Scaleform__GFx__FunctionHandler };
	...
	public:
		...
		void Release()
		{
			static REL::Relocation<decltype(&Movie::Release)> func{ ::Scaleform::ID::GFx::Movie::Release };
			return func(this);
		}
	...
	public:
		...
		// members
		std::byte pad[0x688 - 0x10]; // 10 - To-Do
	};

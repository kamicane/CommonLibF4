...
namespace RE::Scaleform
{
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::Scaleform__SysAllocBase };
		inline static constexpr auto VTABLE{ VTABLE::Scaleform__SysAllocBase };
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::Scaleform__SysAlloc };
		inline static constexpr auto VTABLE{ VTABLE::Scaleform__SysAlloc };
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::Scaleform__SysAllocPaged };
		inline static constexpr auto VTABLE{ VTABLE::Scaleform__SysAllocPaged };

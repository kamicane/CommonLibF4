...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] bool AdvancesUnderPauseMenu() const noexcept { return menuFlags.any(UI_MENU_FLAGS::kAdvancesUnderPauseMenu); }
		[[nodiscard]] bool AssignsCursorToRenderer() const noexcept { return menuFlags.any(UI_MENU_FLAGS::kAssignCursorToRenderer); }
		...
		[[nodiscard]] bool OnStack() const noexcept { return menuFlags.any(UI_MENU_FLAGS::kOnStack); }
		...
		[[nodiscard]] bool RendersUnderPauseMenu() const noexcept { return menuFlags.any(UI_MENU_FLAGS::kRendersUnderPauseMenu); }
		...
		[[nodiscard]] bool UsesCursor() const noexcept { return menuFlags.any(UI_MENU_FLAGS::kUsesCursor); }
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::StartMenuBase };
		inline static constexpr auto VTABLE{ VTABLE::StartMenuBase };
	...
	public:
		...
		[[nodiscard]] static ObjectRefHandle GetCurrentPickREFR()
		{
			...
			return 0 <= index && static_cast<std::size_t>(index) < refs.size() ? refs[static_cast<std::size_t>(index)] : ObjectRefHandle{};
		}
	...
	public:
		...
		REX::Enum<ShowMenuState, std::uint32_t> hudShowMenuState;		  // 218
	};
	...
	public:
		...
		public:
			...
			// members
			REX::Enum<SORT_ON_FIELD, std::uint32_t> currentSort[14]; // 00
		...
		REX::Enum<ContainerMenuMode, std::uint32_t> menuMode;				 // 410
	...
	public:
		...
		REX::Enum<HighlightMode, std::uint32_t> highlightMode; // 330
	...
	public:
		...
		public:
			...
			REX::Enum<CONFIRM_TYPE, std::uint32_t> confirmType{ CONFIRM_TYPE::kSimple }; // 18
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::ExamineMenu };
		inline static constexpr auto VTABLE{ VTABLE::ExamineMenu };
		inline static constexpr auto MENU_NAME{ "ExamineMenu"sv };
		...
		REX::Enum<INSPECT_MODE_STATE, std::uint32_t> inspectModeState;	   // 368
		...
		std::byte attachPointSource3D[0x598 - 0x590];					   // 590 - To-Do
	...
	public:
		...
		std::byte upgrader[0x10];					   // 0F0 - To-Do
	...
	public:
		...
		REX::Enum<Mode, std::uint32_t> mode;											// 240

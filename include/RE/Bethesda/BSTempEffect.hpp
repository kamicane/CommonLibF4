...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] bool Is(TEMP_EFFECT_TYPE a_type) const noexcept { return GetType() == a_type; }
		...
		[[nodiscard]] bool IsNot(TEMP_EFFECT_TYPE a_type) const noexcept { return !Is(a_type); }
		template <class... Args>

...
namespace RE
{
	...
	namespace Workshop
	{
		...
		public:
			...
			inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kWorkshop };
		...
		public:
			...
			std::byte pad38[0x80 - 0x38];		  // 38 - To-Do
			float sinkDepth;					  // 80
			float zOffset;						  // 84
		...
		inline REL::Relocation<PlacementItemData*> CurrentPlacementItemData{ ID::Workshop::CurrentPlacementItemData };
		inline REL::Relocation<std::uint16_t*> CurrentRow{ ID::Workshop::CurrentRow };
		inline REL::Relocation<ObjectRefHandle*> PlacementItem{ ID::Workshop::PlacementItem };
	}
}

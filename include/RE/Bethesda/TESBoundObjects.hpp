...
namespace RE
{
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kCMPO };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kASPC };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kARMO };
		...
		public:
			...
			REX::Enum<STAGGER_MAGNITUDE, std::uint32_t> staggerMagnitude;				 // 50
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kBOOK };

		void SetPerkToAdd(BGSPerk* a_perk)
		{
			using func_t = decltype(&TESObjectBOOK::SetPerkToAdd);
			static REL::Relocation<func_t> func{ REL::ID(472219) }; // skip
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kMISC };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kSTAT };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kSCOL };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kMSTT };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kGRAS };
		...
		public:
			...
			REX::Enum<GRASS_WATER_STATE, std::uint32_t> underwater; // 08
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kTREE };
		...
		REX::Enum<etTreeType, std::uint32_t> type; // 110
	};
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kWEAP };
		...
		public:
			...
			REX::Enum<STAGGER_MAGNITUDE, std::uint32_t> staggerMagnitude;				 // 108
			std::uint32_t value;														 // 10C
			REX::EnumSet<WEAPON_FLAGS, std::uint32_t> flags;							 // 110
			REX::Enum<SOUND_LEVEL, std::uint32_t> soundLevel;							 // 114
			REX::Enum<WEAPONHITBEHAVIOR, std::uint32_t> hitBehavior;					 // 118
			...
			REX::Enum<WEAPON_TYPE, std::uint8_t> type;									 // 137
		};
		...
		float GetShotsPerSecond(InstanceData* a_instanceData)
		{
			...
			static REL::Relocation<func_t> func{ REL::ID(752116) }; // skip
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kAMMO };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kKEYM };
	};
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kIDLM };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kNOTE };
		...
		REX::Enum<NOTE_TYPE, std::uint8_t> type; // 100
	...
	public:
		...
		REX::Enum<Type, std::uint16_t> type;	  // 02
		float gravity;							  // 04
		float speed;							  // 08
		float range;							  // 0C
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kPROJ };
		...
		REX::Enum<SOUND_LEVEL, std::uint32_t> soundLevel; // 180
	};
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kHAZD };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kBNDS };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kSLGM };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kLVLI };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kLVSP };
	};
	...
	public:
		...
		REX::Enum<SOUND_LEVEL, std::uint32_t> soundLevel;			  // 60
		float placedObjectFadeDelay;								  // 64
		REX::Enum<STAGGER_MAGNITUDE, std::uint32_t> staggerMagnitude; // 68
	};
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kEXPL };

		struct RecordFlags
		{
			enum RecordFlag : std::uint32_t
			{
				kExplosionFormFlag_Deleted = 1 << 5,
				kExplosionFormFlag_Ignored = 1 << 12
			};
		};
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kADDN };
	...
	public:
		// members
		std::int8_t priorities[2]; // 00
		std::int8_t modelRange[2]; // 02
		std::int8_t unused[2];	   // 04
		std::int8_t soundValue;	   // 06
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kARMA };
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kARTO };
		...
		public:
			// members
			REX::Enum<ArtType, std::uint32_t> artType; // 00
		};
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kDUAL };

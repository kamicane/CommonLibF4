...
namespace RE
{
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kNone };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kWaterType };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kReferenceHandle };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kCount };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kHealth };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kCharge };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kLock };
		...
		: public TESFullName // 00
	{
		...
		REX::Enum<MARKER_TYPE, std::uint16_t> type; // 12
	};
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kMapMarker };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kTeleport };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kLeveledCreature };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kObjectInstance };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kItemDropper };

		~ExtraItemDropper() override; // 00

		ObjectRefHandle handle; // 10
	};
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kStartingWorldOrCell };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kFavorite };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kAshpileRef };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kAliasInstanceArray };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kLightData };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kLocation };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kTextDisplayData };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kUniqueID };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kBendableSplineParams };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kMaterialSwap };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kInstanceData };
	...
	public:
		...
		inline static constexpr auto TYPE{ EXTRA_DATA_TYPE::kPowerLinks };
	...
	public:
		...
		[[nodiscard]] bool HasType(EXTRA_DATA_TYPE a_type) const noexcept
		{
			...
			if (!flags.empty() && index < flags.size()) {
	...
	public:
		...
		float GetScale()
		{
			...
			static REL::Relocation<func_t> func{ REL::ID(1499172) }; // skip
			return func(this);
		}
		...
		float GetCurrentCharge()
		{
			...
			static REL::Relocation<func_t> func{ REL::ID(980329) }; // skip
			return func(this);
		}
		...
		void SetCurrentCharge(float a_charge)
		{
			...
			static REL::Relocation<func_t> func{ REL::ID(648722) }; // skip

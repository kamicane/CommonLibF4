...
namespace RE::BGSMod
{
	...
	namespace Attachment
	{
		...
		public:
			...
			inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kOMOD };
			...
			public:
				// members
				REX::Enum<ENUM_FORMTYPE, std::uint8_t> targetFormType; // 18
			...
			REX::Enum<ENUM_FORMTYPE, std::uint8_t> targetFormType;						 // C2
